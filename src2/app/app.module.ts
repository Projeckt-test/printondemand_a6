...
@NgModule({
  ...
  entryComponents: [UserListPageComponent, AdduserDialog,ModalboxComponent, EditHtmlDialogComponent, EditStyleDialogComponent, PageSizeComponent, StyleDropdownDialogComponent],
})
