...
import { StyleDropdownDialogComponent } from './editor/style-dropdown-dialog/style-dropdown-dialog.component';

// , EditorOptionDirective
@NgModule({
  declarations: [EditprojectPageComponent, modelDialogComponent, EditchapterPageComponent, EditorComponent, CompareStringPipe, TextFieldComponent, EditHtmlDialogComponent, EditStyleDialogComponent, CustomInputComponent, StyleDropdownDialogComponent],
  imports: [
    CommonModule,
    NgxSpinnerModule,
